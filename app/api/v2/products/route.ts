...
// GET: Consultar Productos (API v2)
  ...
  try {
    ...
    const products = await db.product.findMany({
      ...
      include: {
        ...
        supplier: { select: { id: true, companyName: true, nit: true, contactName: true } },
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    return NextResponse.json({ success: true, apiVersion: "v2", data: newProduct }, { status: 201 });
  } catch (error: any) {
    return NextResponse.json({ success: false, error: error.message }, { status: 500 });
  }
}

// PUT: Editar Producto (API v2)
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    return NextResponse.json({ success: true, apiVersion: "v2", message: "Producto actualizado correctamente" });
  } catch (error: any) {
    return NextResponse.json({ success: false, error: error.message }, { status: 500 });
  }
}

// DELETE: Eliminar Producto (API v2)
export async function DELETE(request: NextRequest) {
  ...
  try {
    ...
    return NextResponse.json({ success: true, apiVersion: "v2", message: "Producto eliminado correctamente" });
  } catch (error: any) {
    return NextResponse.json({ success: false, error: error.message }, { status: 500 });
  }
}
