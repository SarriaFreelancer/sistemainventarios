...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    return NextResponse.json({ success: true, apiVersion: "v2", data: suppliers });
  } catch (error: any) {
    return NextResponse.json({ success: false, error: error.message }, { status: 500 });
  }
}

// POST: Crear Proveedor (v2)
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    return NextResponse.json({ success: true, apiVersion: "v2", data: supplier }, { status: 201 });
  } catch (error: any) {
    return NextResponse.json({ success: false, error: error.message }, { status: 500 });
  }
}

// PUT: Editar Proveedor (v2)
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    return NextResponse.json({ success: true, apiVersion: "v2", message: "Proveedor actualizado correctamente" });
  } catch (error: any) {
    return NextResponse.json({ success: false, error: error.message }, { status: 500 });
  }
}

// DELETE: Eliminar Proveedor (v2)
export async function DELETE(request: NextRequest) {
  ...
  try {
    ...
    return NextResponse.json({ success: true, apiVersion: "v2", message: "Proveedor eliminado correctamente" });
  } catch (error: any) {
    return NextResponse.json({ success: false, error: error.message }, { status: 500 });
  }
}
