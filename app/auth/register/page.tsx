  ...
  const onSubmit = async (values: z.infer<typeof registerSchema>) => {
    try {
      ...
      if (response.ok) {
        ...
        await Swal.fire({
          icon: 'success',
          title: '¡Prueba de 15 Días Activada!',
          text: 'Tu cuenta corporativa ha sido creada exitosamente. Tienes 15 días de acceso total y gratuito para probar todos los módulos y herramientas del sistema.',
