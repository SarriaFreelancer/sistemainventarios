...
export function NewPurchaseRequestModal() {
  ...
  const handleOpen = () => {
    ...
    setNotes("");
    setExpectedDate("");
    setItems([{ description: "", quantity: 1, itemType: "PRODUCTO_VENTA" }]);
    setIsOpen(true);
  };
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4 sm:p-6">
          <div className="bg-background rounded-3xl shadow-xl w-full max-w-5xl max-h-[90vh] overflow-y-auto border border-border">
            <div className="sticky top-0 bg-background/95 backdrop-blur z-10 flex items-center justify-between border-b border-border p-6">
              <div>
                <h2 className="text-2xl font-bold tracking-tight text-foreground">Nueva Solicitud de Compra</h2>
                <p className="text-sm text-muted-foreground">Crea una petición formal (Fase 1) para ser cotizada o aprobada.</p>
              </div>
              <button 
