  ...
  try {
    ...
    const updated = await prisma.companySetting.update({
      ...
      data: {
        ...
        registerInventoryCostAsExpense: data.registerInventoryCostAsExpense,
        ...
        passwordMaxLength: Number(data.passwordMaxLength ?? 128),
        ...
        passwordRequireSymbols: Boolean(data.passwordRequireSymbols),
